...
namespace KbdListener
{
	...
	public class KeyboardListener
	{
        ...
        private static Dictionary<ushort, KeyState> keyStates = new Dictionary<ushort, KeyState>();
		...
		private static void KeyHandler(ushort key, uint msg)
		{
			if(s_KeyEventHandler != null)
			{
				...
				{
					KeyboardHandler sink = (KeyboardHandler)del;

					try
					{
						// This is a static class, therefore null is passed as the object reference
						sink(new UniversalKeyEventArgs(key,msg), keyStates);
					}
        ...
        public delegate void KeyboardHandler(EventArgs e, Dictionary<ushort, KeyState> keyStates);
		/// <summary>
		/// For every application thread that is interested in keyboard events
		/// an EventHandler can be added to this variable
		/// </summary>
		public static event KeyboardHandler s_KeyEventHandler;
